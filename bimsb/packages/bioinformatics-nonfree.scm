...
(define-public methyldackel
  (package
    ...
    (description
     " MethylDackel (formerly named PileOMeth) will process a
coordinate-sorted and indexed BAM or CRAM file containing some form of
BS-seq alignments and extract per-base methylation metrics from them.
MethylDackel requires an indexed fasta file containing the reference
genome as well.")
    ;; https://github.com/dpryan79/MethylDackel/issues/85
    (license nonfree:undeclared)))
